...
def arp_poising(target_ip, poisened_ip):
    ...
    scapy.send(arp_scope)#We send the packages created with the scapy.send function to the destinations.--Scapy.send fonksiyonu ile oluşturulan paketleri hedeflere gönderiyoruz.
